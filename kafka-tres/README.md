...
Kafka Tres is a Simple Three Node Kafka Cluster with TLS for External/Client Connections.
...
By default a common CA is create with 3 Certs, 1 for the Kafka Brokers to use and 2 additional Certs for Kafka Clients to use.
